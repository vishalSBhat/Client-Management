        ...
        success: res => {
            ...
            $(".case-list").prepend(`<li class="my-2 case-list-item">
                    ...
                    <img
                        ...
                        src="/icons/icons/box-arrow-up-right.svg"
                        alt="Open"
                    />
                    </li>`);
...
function loadDocuments(list) {
    const checkBox = status => {
        ...
        icon = "/icons/icons/file-earmark-minus.svg";
...
function recordItemGenerator(rec) {
    return (
        ...
        <h5 class="col-5 col-sm-2 mr-2 mt-1 p-0 transaction-date"><img onclick="deleteRecord('${rec._id}')" class="mr-1 transaction-del-icon" src="/icons/icons/trash.svg" alt="Delete" /> ${rec.date}</h5>
